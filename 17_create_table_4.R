...
################################################
##                                            ##
## PROGRAM NAME: 17_create_table_4            ##
## DESCRIPTION:                               ##
##                                            ##
...
for (i in 1:nmi) {
	...
	idata<-phdcn[,c(vars.b.cm,vars.w1.cm,"nppvt_3","nlnbll_3","nlnbll_2","nlnbll_1","nsubage_3")]
	...
	boot.est.cm<-foreach(h=1:nboot, .combine=cbind) %dopar% {
		...
		boot.idata<-boot.phdcn[,c(vars.b.cm,vars.w1.cm,"nppvt_3","nlnbll_3","nlnbll_2","nlnbll_1","nsubage_3")]
...
sink("D:\\projects\\skill_gaps_lead\\programs\\_LOGS\\17_create_table_4_log.txt")
...
save(lm.gap.w1,lm.gap.w2,lm.gap.w3,lm.gap.cm,
     ...
     ob.gap,
     file="D:\\projects\\skill_gaps_lead\\data\\_TEMP\\ppvt.gap.est.RData")
