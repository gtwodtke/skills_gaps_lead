...
################################################
##                                            ##
## PROGRAM NAME: 01_create_table_a1           ##
## AUTHOR: GW                                 ##
## DATE: 8/4/2021                             ##
## UPDATED: 3/21/2022                         ##
## DESCRIPTION:                               ##
...
phdcnmi$abovehs_b<-phdcnmi$npchsgrad_b+phdcnmi$npcsomcol_b+phdcnmi$npccolgrd_b
q2<-quantile(phdcnmi$nlninc_1,p=0.5)
phdcnmi$incq2<-0
phdcnmi$incq2[phdcnmi$nlninc_1<q2]<-1
...
rf.w1<-train(nppvt_3~.,data=phdcn.tune[,vars.w1],method="ranger",tuneGrid=rf.grid.w1,trControl=cntrl,metric="RMSE",respect.unordered.factors=TRUE,num.trees=ntrees,seed=8675309)
rf.w2<-train(nppvt_3~.,data=phdcn.tune[,vars.w2],method="ranger",tuneGrid=rf.grid.w2,trControl=cntrl,metric="RMSE",respect.unordered.factors=TRUE,num.trees=ntrees,seed=8675309)
rf.w3<-train(nppvt_3~.,data=phdcn.tune[,vars.w3],method="ranger",tuneGrid=rf.grid.w3,trControl=cntrl,metric="RMSE",respect.unordered.factors=TRUE,num.trees=ntrees,seed=8675309)
...
rt.w1<-train(nppvt_3~.,data=phdcn.tune[,vars.w1],method="rpart",tuneGrid=rt.grid,trControl=cntrl,metric="RMSE",minsplit=2,minbucket=1)
rt.w2<-train(nppvt_3~.,data=phdcn.tune[,vars.w2],method="rpart",tuneGrid=rt.grid,trControl=cntrl,metric="RMSE",minsplit=2,minbucket=1)
rt.w3<-train(nppvt_3~.,data=phdcn.tune[,vars.w3],method="rpart",tuneGrid=rt.grid,trControl=cntrl,metric="RMSE",minsplit=2,minbucket=1)
...
miest.lm.w1<-mivar.lm.w1<-miest.lm.w2<-mivar.lm.w2<-miest.lm.w3<-mivar.lm.w3<-matrix(data=NA,nrow=nmi,ncol=2)
miest.rt.w1<-mivar.rt.w1<-miest.rt.w2<-mivar.rt.w2<-miest.rt.w3<-mivar.rt.w3<-matrix(data=NA,nrow=nmi,ncol=2)
miest.rf.w1<-mivar.rf.w1<-miest.rf.w2<-mivar.rf.w2<-miest.rf.w3<-mivar.rf.w3<-matrix(data=NA,nrow=nmi,ncol=2)
miest.sl.w1<-mivar.sl.w1<-miest.sl.w2<-mivar.sl.w2<-miest.sl.w3<-mivar.sl.w3<-matrix(data=NA,nrow=nmi,ncol=2)

midest.lm.w1<-midvar.lm.w1<-midest.lm.w2<-midvar.lm.w2<-midest.lm.w3<-midvar.lm.w3<-matrix(data=NA,nrow=nmi,ncol=2)
midest.rt.w1<-midvar.rt.w1<-midest.rt.w2<-midvar.rt.w2<-midest.rt.w3<-midvar.rt.w3<-matrix(data=NA,nrow=nmi,ncol=2)
midest.rf.w1<-midvar.rf.w1<-midest.rf.w2<-midvar.rf.w2<-midest.rf.w3<-midvar.rf.w3<-matrix(data=NA,nrow=nmi,ncol=2)
midest.sl.w1<-midvar.sl.w1<-midest.sl.w2<-midvar.sl.w2<-midest.sl.w3<-midvar.sl.w3<-matrix(data=NA,nrow=nmi,ncol=2)
...
for (i in 1:nmi) {
	...
	### OBSERVED GAPS ###
	m0.inc<-lm(nppvt_3~incq2,data=phdcn)
	m0.educ<-lm(nppvt_3~abovehs_b,data=phdcn)
	q21gap.obs<-m0.inc$coefficients[2]
	nvdgap.obs<-m0.educ$coefficients[2]*(-1)

	miest.ob[i,1]<-q21gap.obs
	miest.ob[i,2]<-nvdgap.obs
	...
	idata<-phdcn[,c(vars.w1,"incq2","abovehs_b")]
	idata$nlnbll_1<-m	
	...
	uhat.sl<-uhat$pred
	m2.lm.w1.inc<-lm(uhat.lm~incq2,data=idata)
	m2.lm.w1.educ<-lm(uhat.lm~abovehs_b,data=idata)
	miest.lm.w1[i,1]<-m2.lm.w1.inc$coefficients[2]
	miest.lm.w1[i,2]<-m2.lm.w1.educ$coefficients[2]*(-1)
	m2.rt.w1.inc<-lm(uhat.rt~incq2,data=idata)
	m2.rt.w1.educ<-lm(uhat.rt~abovehs_b,data=idata)
	miest.rt.w1[i,1]<-m2.rt.w1.inc$coefficients[2]
	miest.rt.w1[i,2]<-m2.rt.w1.educ$coefficients[2]*(-1)
	m2.rf.w1.inc<-lm(uhat.rf~incq2,data=idata)
	m2.rf.w1.educ<-lm(uhat.rf~abovehs_b,data=idata)
	miest.rf.w1[i,1]<-m2.rf.w1.inc$coefficients[2]
	miest.rf.w1[i,2]<-m2.rf.w1.educ$coefficients[2]*(-1)
	m2.sl.w1.inc<-lm(uhat.sl~incq2,data=idata)
	m2.sl.w1.educ<-lm(uhat.sl~abovehs_b,data=idata)
	miest.sl.w1[i,1]<-m2.sl.w1.inc$coefficients[2]
	miest.sl.w1[i,2]<-m2.sl.w1.educ$coefficients[2]*(-1)
	...
	idata<-phdcn[,c(vars.w2,"incq2","abovehs_b")]
	idata$nlnbll_2<-m	
	...
	uhat.rf<-uhat$library.predict[,3]
	uhat.sl<-uhat$pred
	m2.lm.w2.inc<-lm(uhat.lm~incq2,data=idata)
	m2.lm.w2.educ<-lm(uhat.lm~abovehs_b,data=idata)
	miest.lm.w2[i,1]<-m2.lm.w2.inc$coefficients[2]
	miest.lm.w2[i,2]<-m2.lm.w2.educ$coefficients[2]*(-1)
	m2.rt.w2.inc<-lm(uhat.rt~incq2,data=idata)
	m2.rt.w2.educ<-lm(uhat.rt~abovehs_b,data=idata)
	miest.rt.w2[i,1]<-m2.rt.w2.inc$coefficients[2]
	miest.rt.w2[i,2]<-m2.rt.w2.educ$coefficients[2]*(-1)
	m2.rf.w2.inc<-lm(uhat.rf~incq2,data=idata)
	m2.rf.w2.educ<-lm(uhat.rf~abovehs_b,data=idata)
	miest.rf.w2[i,1]<-m2.rf.w2.inc$coefficients[2]
	miest.rf.w2[i,2]<-m2.rf.w2.educ$coefficients[2]*(-1)
	m2.sl.w2.inc<-lm(uhat.sl~incq2,data=idata)
	m2.sl.w2.educ<-lm(uhat.sl~abovehs_b,data=idata)
	miest.sl.w2[i,1]<-m2.sl.w2.inc$coefficients[2]
	miest.sl.w2[i,2]<-m2.sl.w2.educ$coefficients[2]*(-1)
	...
	idata<-phdcn[,c(vars.w3,"incq2","abovehs_b")]
	idata$nlnbll_3<-m	
	...
	uhat.rf<-uhat$library.predict[,3]
	uhat.sl<-uhat$pred
	m2.lm.w3.inc<-lm(uhat.lm~incq2,data=idata)
	m2.lm.w3.educ<-lm(uhat.lm~abovehs_b,data=idata)
	miest.lm.w3[i,1]<-m2.lm.w3.inc$coefficients[2]
	miest.lm.w3[i,2]<-m2.lm.w3.educ$coefficients[2]*(-1)
	m2.rt.w3.inc<-lm(uhat.rt~incq2,data=idata)
	m2.rt.w3.educ<-lm(uhat.rt~abovehs_b,data=idata)
	miest.rt.w3[i,1]<-m2.rt.w3.inc$coefficients[2]
	miest.rt.w3[i,2]<-m2.rt.w3.educ$coefficients[2]*(-1)
	m2.rf.w3.inc<-lm(uhat.rf~incq2,data=idata)
	m2.rf.w3.educ<-lm(uhat.rf~abovehs_b,data=idata)
	miest.rf.w3[i,1]<-m2.rf.w3.inc$coefficients[2]
	miest.rf.w3[i,2]<-m2.rf.w3.educ$coefficients[2]*(-1)
	m2.sl.w3.inc<-lm(uhat.sl~incq2,data=idata)
	m2.sl.w3.educ<-lm(uhat.sl~abovehs_b,data=idata)
	miest.sl.w3[i,1]<-m2.sl.w3.inc$coefficients[2]
	miest.sl.w3[i,2]<-m2.sl.w3.educ$coefficients[2]*(-1)

	midest.lm.w1[i,1]<-miest.lm.w1[i,1]-q21gap.obs
	midest.lm.w1[i,2]<-miest.lm.w1[i,2]-nvdgap.obs
	midest.lm.w2[i,1]<-miest.lm.w2[i,1]-q21gap.obs
	midest.lm.w2[i,2]<-miest.lm.w2[i,2]-nvdgap.obs
	midest.lm.w3[i,1]<-miest.lm.w3[i,1]-q21gap.obs
	midest.lm.w3[i,2]<-miest.lm.w3[i,2]-nvdgap.obs

	midest.rt.w1[i,1]<-miest.rt.w1[i,1]-q21gap.obs
	midest.rt.w1[i,2]<-miest.rt.w1[i,2]-nvdgap.obs
	midest.rt.w2[i,1]<-miest.rt.w2[i,1]-q21gap.obs
	midest.rt.w2[i,2]<-miest.rt.w2[i,2]-nvdgap.obs
	midest.rt.w3[i,1]<-miest.rt.w3[i,1]-q21gap.obs
	midest.rt.w3[i,2]<-miest.rt.w3[i,2]-nvdgap.obs

	midest.rf.w1[i,1]<-miest.rf.w1[i,1]-q21gap.obs
	midest.rf.w1[i,2]<-miest.rf.w1[i,2]-nvdgap.obs
	midest.rf.w2[i,1]<-miest.rf.w2[i,1]-q21gap.obs
	midest.rf.w2[i,2]<-miest.rf.w2[i,2]-nvdgap.obs
	midest.rf.w3[i,1]<-miest.rf.w3[i,1]-q21gap.obs
	midest.rf.w3[i,2]<-miest.rf.w3[i,2]-nvdgap.obs

	midest.sl.w1[i,1]<-miest.sl.w1[i,1]-q21gap.obs
	midest.sl.w1[i,2]<-miest.sl.w1[i,2]-nvdgap.obs
	midest.sl.w2[i,1]<-miest.sl.w2[i,1]-q21gap.obs
	midest.sl.w2[i,2]<-miest.sl.w2[i,2]-nvdgap.obs
	midest.sl.w3[i,1]<-miest.sl.w3[i,1]-q21gap.obs
	midest.sl.w3[i,2]<-miest.sl.w3[i,2]-nvdgap.obs
	...
	boot.est<-foreach(h=1:nboot, .combine=cbind) %dopar% {
		...
		boot.m0.inc<-lm(nppvt_3~incq2,data=boot.phdcn)
		boot.m0.educ<-lm(nppvt_3~abovehs_b,data=boot.phdcn)
		boot.q21gap.obs<-boot.m0.inc$coefficients[2]
		boot.nvdgap.obs<-boot.m0.educ$coefficients[2]*(-1)

		boot.y.train<-boot.phdcn[,"nppvt_3"]
		...
		boot.idata<-boot.phdcn[,c(vars.w1,"incq2","abovehs_b")]
		...
		boot.m2.lm.w1.inc<-lm(boot.uhat.lm~incq2,data=boot.idata)
		boot.m2.lm.w1.educ<-lm(boot.uhat.lm~abovehs_b,data=boot.idata)
		boot.q21gap.lm.w1<-boot.m2.lm.w1.inc$coefficients[2]
		boot.nvdgap.lm.w1<-boot.m2.lm.w1.educ$coefficients[2]*(-1)
		boot.m2.rt.w1.inc<-lm(boot.uhat.rt~incq2,data=boot.idata)
		boot.m2.rt.w1.educ<-lm(boot.uhat.rt~abovehs_b,data=boot.idata)
		boot.q21gap.rt.w1<-boot.m2.rt.w1.inc$coefficients[2]
		boot.nvdgap.rt.w1<-boot.m2.rt.w1.educ$coefficients[2]*(-1)
		boot.m2.rf.w1.inc<-lm(boot.uhat.rf~incq2,data=boot.idata)
		boot.m2.rf.w1.educ<-lm(boot.uhat.rf~abovehs_b,data=boot.idata)
		boot.q21gap.rf.w1<-boot.m2.rf.w1.inc$coefficients[2]
		boot.nvdgap.rf.w1<-boot.m2.rf.w1.educ$coefficients[2]*(-1)
		boot.m2.sl.w1.inc<-lm(boot.uhat.sl~incq2,data=boot.idata)
		boot.m2.sl.w1.educ<-lm(boot.uhat.sl~abovehs_b,data=boot.idata)
		boot.q21gap.sl.w1<-boot.m2.sl.w1.inc$coefficients[2]
		...
		boot.idata<-boot.phdcn[,c(vars.w2,"incq2","abovehs_b")]
		...
		boot.uhat.rf<-boot.uhat$library.predict[,3]
		boot.uhat.sl<-boot.uhat$pred
		boot.m2.lm.w2.inc<-lm(boot.uhat.lm~incq2,data=boot.idata)
		boot.m2.lm.w2.educ<-lm(boot.uhat.lm~abovehs_b,data=boot.idata)
		boot.q21gap.lm.w2<-boot.m2.lm.w2.inc$coefficients[2]
		boot.nvdgap.lm.w2<-boot.m2.lm.w2.educ$coefficients[2]*(-1)
		boot.m2.rt.w2.inc<-lm(boot.uhat.rt~incq2,data=boot.idata)
		boot.m2.rt.w2.educ<-lm(boot.uhat.rt~abovehs_b,data=boot.idata)
		boot.q21gap.rt.w2<-boot.m2.rt.w2.inc$coefficients[2]
		boot.nvdgap.rt.w2<-boot.m2.rt.w2.educ$coefficients[2]*(-1)
		boot.m2.rf.w2.inc<-lm(boot.uhat.rf~incq2,data=boot.idata)
		boot.m2.rf.w2.educ<-lm(boot.uhat.rf~abovehs_b,data=boot.idata)
		boot.q21gap.rf.w2<-boot.m2.rf.w2.inc$coefficients[2]
		boot.nvdgap.rf.w2<-boot.m2.rf.w2.educ$coefficients[2]*(-1)
		boot.m2.sl.w2.inc<-lm(boot.uhat.sl~incq2,data=boot.idata)
		boot.m2.sl.w2.educ<-lm(boot.uhat.sl~abovehs_b,data=boot.idata)
		boot.q21gap.sl.w2<-boot.m2.sl.w2.inc$coefficients[2]
		...
		boot.idata<-boot.phdcn[,c(vars.w3,"incq2","abovehs_b")]
		...
		boot.uhat.rf<-boot.uhat$library.predict[,3]
		boot.uhat.sl<-boot.uhat$pred
		boot.m2.lm.w3.inc<-lm(boot.uhat.lm~incq2,data=boot.idata)
		boot.m2.lm.w3.educ<-lm(boot.uhat.lm~abovehs_b,data=boot.idata)
		boot.q21gap.lm.w3<-boot.m2.lm.w3.inc$coefficients[2]
		boot.nvdgap.lm.w3<-boot.m2.lm.w3.educ$coefficients[2]*(-1)
		boot.m2.rt.w3.inc<-lm(boot.uhat.rt~incq2,data=boot.idata)
		boot.m2.rt.w3.educ<-lm(boot.uhat.rt~abovehs_b,data=boot.idata)
		boot.q21gap.rt.w3<-boot.m2.rt.w3.inc$coefficients[2]
		boot.nvdgap.rt.w3<-boot.m2.rt.w3.educ$coefficients[2]*(-1)
		boot.m2.rf.w3.inc<-lm(boot.uhat.rf~incq2,data=boot.idata)
		boot.m2.rf.w3.educ<-lm(boot.uhat.rf~abovehs_b,data=boot.idata)
		boot.q21gap.rf.w3<-boot.m2.rf.w3.inc$coefficients[2]
		boot.nvdgap.rf.w3<-boot.m2.rf.w3.educ$coefficients[2]*(-1)
		boot.m2.sl.w3.inc<-lm(boot.uhat.sl~incq2,data=boot.idata)
		boot.m2.sl.w3.educ<-lm(boot.uhat.sl~abovehs_b,data=boot.idata)
		boot.q21gap.sl.w3<-boot.m2.sl.w3.inc$coefficients[2]
		boot.nvdgap.sl.w3<-boot.m2.sl.w3.educ$coefficients[2]*(-1)
	
		boot.q21gap.lm.w1.d<-boot.q21gap.lm.w1-boot.q21gap.obs
		boot.nvdgap.lm.w1.d<-boot.nvdgap.lm.w1-boot.nvdgap.obs
		boot.q21gap.rt.w1.d<-boot.q21gap.rt.w1-boot.q21gap.obs
		boot.nvdgap.rt.w1.d<-boot.nvdgap.rt.w1-boot.nvdgap.obs
		boot.q21gap.rf.w1.d<-boot.q21gap.rf.w1-boot.q21gap.obs
		boot.nvdgap.rf.w1.d<-boot.nvdgap.rf.w1-boot.nvdgap.obs
		boot.q21gap.sl.w1.d<-boot.q21gap.sl.w1-boot.q21gap.obs
		boot.nvdgap.sl.w1.d<-boot.nvdgap.sl.w1-boot.nvdgap.obs

		boot.q21gap.lm.w2.d<-boot.q21gap.lm.w2-boot.q21gap.obs
		boot.nvdgap.lm.w2.d<-boot.nvdgap.lm.w2-boot.nvdgap.obs
		boot.q21gap.rt.w2.d<-boot.q21gap.rt.w2-boot.q21gap.obs
		boot.nvdgap.rt.w2.d<-boot.nvdgap.rt.w2-boot.nvdgap.obs
		boot.q21gap.rf.w2.d<-boot.q21gap.rf.w2-boot.q21gap.obs
		boot.nvdgap.rf.w2.d<-boot.nvdgap.rf.w2-boot.nvdgap.obs
		boot.q21gap.sl.w2.d<-boot.q21gap.sl.w2-boot.q21gap.obs
		boot.nvdgap.sl.w2.d<-boot.nvdgap.sl.w2-boot.nvdgap.obs

		boot.q21gap.lm.w3.d<-boot.q21gap.lm.w3-boot.q21gap.obs
		boot.nvdgap.lm.w3.d<-boot.nvdgap.lm.w3-boot.nvdgap.obs
		boot.q21gap.rt.w3.d<-boot.q21gap.rt.w3-boot.q21gap.obs
		boot.nvdgap.rt.w3.d<-boot.nvdgap.rt.w3-boot.nvdgap.obs
		boot.q21gap.rf.w3.d<-boot.q21gap.rf.w3-boot.q21gap.obs
		boot.nvdgap.rf.w3.d<-boot.nvdgap.rf.w3-boot.nvdgap.obs
		boot.q21gap.sl.w3.d<-boot.q21gap.sl.w3-boot.q21gap.obs
		boot.nvdgap.sl.w3.d<-boot.nvdgap.sl.w3-boot.nvdgap.obs

		return(
			list(
				boot.q21gap.obs,boot.nvdgap.obs,
				boot.q21gap.lm.w1,boot.nvdgap.lm.w1,
				boot.q21gap.lm.w2,boot.nvdgap.lm.w2,
				boot.q21gap.lm.w3,boot.nvdgap.lm.w3,
				boot.q21gap.rt.w1,boot.nvdgap.rt.w1,
				boot.q21gap.rt.w2,boot.nvdgap.rt.w2,
				boot.q21gap.rt.w3,boot.nvdgap.rt.w3,
				boot.q21gap.rf.w1,boot.nvdgap.rf.w1,
				boot.q21gap.rf.w2,boot.nvdgap.rf.w2,
				boot.q21gap.rf.w3,boot.nvdgap.rf.w3,
				boot.q21gap.sl.w1,boot.nvdgap.sl.w1,
				boot.q21gap.sl.w2,boot.nvdgap.sl.w2,
				boot.q21gap.sl.w3,boot.nvdgap.sl.w3,
				boot.q21gap.lm.w1.d,boot.nvdgap.lm.w1.d,
				boot.q21gap.lm.w2.d,boot.nvdgap.lm.w2.d,
				boot.q21gap.lm.w3.d,boot.nvdgap.lm.w3.d,
				boot.q21gap.rt.w1.d,boot.nvdgap.rt.w1.d,
				boot.q21gap.rt.w2.d,boot.nvdgap.rt.w2.d,
				boot.q21gap.rt.w3.d,boot.nvdgap.rt.w3.d,
				boot.q21gap.rf.w1.d,boot.nvdgap.rf.w1.d,
				boot.q21gap.rf.w2.d,boot.nvdgap.rf.w2.d,
				boot.q21gap.rf.w3.d,boot.nvdgap.rf.w3.d,
				boot.q21gap.sl.w1.d,boot.nvdgap.sl.w1.d,
				boot.q21gap.sl.w2.d,boot.nvdgap.sl.w2.d,
				boot.q21gap.sl.w3.d,boot.nvdgap.sl.w3.d))
		}

	boot.est<-matrix(unlist(boot.est),ncol=50,byrow=TRUE)

	mivar.ob[i,1]<-var(boot.est[,1])
	mivar.ob[i,2]<-var(boot.est[,2])
	
	mivar.lm.w1[i,1]<-var(boot.est[,3])
	mivar.lm.w1[i,2]<-var(boot.est[,4])
	mivar.lm.w2[i,1]<-var(boot.est[,5])
	mivar.lm.w2[i,2]<-var(boot.est[,6])
	mivar.lm.w3[i,1]<-var(boot.est[,7])
	mivar.lm.w3[i,2]<-var(boot.est[,8])

	mivar.rt.w1[i,1]<-var(boot.est[,9])
	mivar.rt.w1[i,2]<-var(boot.est[,10])
	mivar.rt.w2[i,1]<-var(boot.est[,11])
	mivar.rt.w2[i,2]<-var(boot.est[,12])
	mivar.rt.w3[i,1]<-var(boot.est[,13])
	mivar.rt.w3[i,2]<-var(boot.est[,14])

	mivar.rf.w1[i,1]<-var(boot.est[,15])
	mivar.rf.w1[i,2]<-var(boot.est[,16])
	mivar.rf.w2[i,1]<-var(boot.est[,17])
	mivar.rf.w2[i,2]<-var(boot.est[,18])
	mivar.rf.w3[i,1]<-var(boot.est[,19])
	mivar.rf.w3[i,2]<-var(boot.est[,20])

	mivar.sl.w1[i,1]<-var(boot.est[,21])
	mivar.sl.w1[i,2]<-var(boot.est[,22])
	mivar.sl.w2[i,1]<-var(boot.est[,23])
	mivar.sl.w2[i,2]<-var(boot.est[,24])
	mivar.sl.w3[i,1]<-var(boot.est[,25])
	mivar.sl.w3[i,2]<-var(boot.est[,26])
	
	midvar.lm.w1[i,1]<-var(boot.est[,27])
	midvar.lm.w1[i,2]<-var(boot.est[,28])
	midvar.lm.w2[i,1]<-var(boot.est[,29])
	midvar.lm.w2[i,2]<-var(boot.est[,30])
	midvar.lm.w3[i,1]<-var(boot.est[,31])
	midvar.lm.w3[i,2]<-var(boot.est[,32])

	midvar.rt.w1[i,1]<-var(boot.est[,33])
	midvar.rt.w1[i,2]<-var(boot.est[,34])
	midvar.rt.w2[i,1]<-var(boot.est[,35])
	midvar.rt.w2[i,2]<-var(boot.est[,36])
	midvar.rt.w3[i,1]<-var(boot.est[,37])
	midvar.rt.w3[i,2]<-var(boot.est[,38])

	midvar.rf.w1[i,1]<-var(boot.est[,39])
	midvar.rf.w1[i,2]<-var(boot.est[,40])
	midvar.rf.w2[i,1]<-var(boot.est[,41])
	midvar.rf.w2[i,2]<-var(boot.est[,42])
	midvar.rf.w3[i,1]<-var(boot.est[,43])
	midvar.rf.w3[i,2]<-var(boot.est[,44])

	midvar.sl.w1[i,1]<-var(boot.est[,45])
	midvar.sl.w1[i,2]<-var(boot.est[,46])
	midvar.sl.w2[i,1]<-var(boot.est[,47])
	midvar.sl.w2[i,2]<-var(boot.est[,48])
	midvar.sl.w3[i,1]<-var(boot.est[,49])
	midvar.sl.w3[i,2]<-var(boot.est[,50])
	}

### COMBINE MI ESTIMATES ###
ob.est<-matrix(data=NA,nrow=2,ncol=2)

lm.est.w1<-lm.est.w2<-lm.est.w3<-matrix(data=NA,nrow=2,ncol=2)
rt.est.w1<-rt.est.w2<-rt.est.w3<-matrix(data=NA,nrow=2,ncol=2)
rf.est.w1<-rf.est.w2<-rf.est.w3<-matrix(data=NA,nrow=2,ncol=2)
sl.est.w1<-sl.est.w2<-sl.est.w3<-matrix(data=NA,nrow=2,ncol=2)

lm.dif.w1<-lm.dif.w2<-lm.dif.w3<-matrix(data=NA,nrow=2,ncol=4)
rt.dif.w1<-rt.dif.w2<-rt.dif.w3<-matrix(data=NA,nrow=2,ncol=4)
rf.dif.w1<-rf.dif.w2<-rf.dif.w3<-matrix(data=NA,nrow=2,ncol=4)
sl.dif.w1<-sl.dif.w2<-sl.dif.w3<-matrix(data=NA,nrow=2,ncol=4)
...
##### ESTIMATE COUNTERFACTUAL GAPS #####
miest.lm.cm<-miest.rt.cm<-miest.rf.cm<-miest.sl.cm<-matrix(data=NA,nrow=nmi,ncol=2)
mivar.lm.cm<-mivar.rt.cm<-mivar.rf.cm<-mivar.sl.cm<-matrix(data=NA,nrow=nmi,ncol=2)

midest.lm.cm<-midest.rt.cm<-midest.rf.cm<-midest.sl.cm<-matrix(data=NA,nrow=nmi,ncol=2)
midvar.lm.cm<-midvar.rt.cm<-midvar.rf.cm<-midvar.sl.cm<-matrix(data=NA,nrow=nmi,ncol=2)
...
for (i in 1:nmi) {
	...
	idata<-phdcn[,c(vars.b.cm,vars.w1.cm,"nppvt_3","nlnbll_3","nlnbll_2","nlnbll_1","nsubage_3","incq2","abovehs_b")]
	...
	uhat.rf<-uhat$library.predict[,3]
	uhat.sl<-uhat$pred
	m2.lm.inc<-lm(uhat.lm~incq2,data=idata)
	m2.lm.educ<-lm(uhat.lm~abovehs_b,data=idata)
	miest.lm.cm[i,1]<-m2.lm.inc$coefficients[2]
	miest.lm.cm[i,2]<-m2.lm.educ$coefficients[2]*(-1)
	m2.rt.inc<-lm(uhat.rt~incq2,data=idata)
	m2.rt.educ<-lm(uhat.rt~abovehs_b,data=idata)
	miest.rt.cm[i,1]<-m2.rt.inc$coefficients[2]
	miest.rt.cm[i,2]<-m2.rt.educ$coefficients[2]*(-1)
	m2.rf.inc<-lm(uhat.rf~incq2,data=idata)
	m2.rf.educ<-lm(uhat.rf~abovehs_b,data=idata)
	miest.rf.cm[i,1]<-m2.rf.inc$coefficients[2]
	miest.rf.cm[i,2]<-m2.rf.educ$coefficients[2]*(-1)
	m2.sl.inc<-lm(uhat.sl~incq2,data=idata)
	m2.sl.educ<-lm(uhat.sl~abovehs_b,data=idata)
	miest.sl.cm[i,1]<-m2.sl.inc$coefficients[2]
	miest.sl.cm[i,2]<-m2.sl.educ$coefficients[2]*(-1)

	midest.lm.cm[i,1]<-miest.lm.cm[i,1]-q21gap.obs
	midest.lm.cm[i,2]<-miest.lm.cm[i,2]-nvdgap.obs

	midest.rt.cm[i,1]<-miest.rt.cm[i,1]-q21gap.obs
	midest.rt.cm[i,2]<-miest.rt.cm[i,2]-nvdgap.obs

	midest.rf.cm[i,1]<-miest.rf.cm[i,1]-q21gap.obs
	midest.rf.cm[i,2]<-miest.rf.cm[i,2]-nvdgap.obs

	midest.sl.cm[i,1]<-miest.sl.cm[i,1]-q21gap.obs
	midest.sl.cm[i,2]<-miest.sl.cm[i,2]-nvdgap.obs
	...
	boot.est.cm<-foreach(h=1:nboot, .combine=cbind) %dopar% {
		...
		boot.idata<-boot.phdcn[,c(vars.b.cm,vars.w1.cm,"nppvt_3","nlnbll_3","nlnbll_2","nlnbll_1","nsubage_3","incq2","abovehs_b")]
		...
		boot.uhat.rf<-boot.uhat$library.predict[,3]
		boot.uhat.sl<-boot.uhat$pred
		boot.m2.lm.inc<-lm(boot.uhat.lm~incq2,data=boot.idata)
		boot.m2.lm.educ<-lm(boot.uhat.lm~abovehs_b,data=boot.idata)
		boot.q21gap.lm.cm<-boot.m2.lm.inc$coefficients[2]
		boot.nvdgap.lm.cm<-boot.m2.lm.educ$coefficients[2]*(-1)
		boot.m2.rt.inc<-lm(boot.uhat.rt~incq2,data=boot.idata)
		boot.m2.rt.educ<-lm(boot.uhat.rt~abovehs_b,data=boot.idata)
		boot.q21gap.rt.cm<-boot.m2.rt.inc$coefficients[2]
		boot.nvdgap.rt.cm<-boot.m2.rt.educ$coefficients[2]*(-1)
		boot.m2.rf.inc<-lm(boot.uhat.rf~incq2,data=boot.idata)
		boot.m2.rf.educ<-lm(boot.uhat.rf~abovehs_b,data=boot.idata)
		boot.q21gap.rf.cm<-boot.m2.rf.inc$coefficients[2]
		boot.nvdgap.rf.cm<-boot.m2.rf.educ$coefficients[2]*(-1)
		boot.m2.sl.inc<-lm(boot.uhat.sl~incq2,data=boot.idata)
		boot.m2.sl.educ<-lm(boot.uhat.sl~abovehs_b,data=boot.idata)
		boot.q21gap.sl.cm<-boot.m2.sl.inc$coefficients[2]
		boot.nvdgap.sl.cm<-boot.m2.sl.educ$coefficients[2]*(-1)

		boot.q21gap.lm.cm.d<-boot.q21gap.lm.cm-boot.q21gap.obs
		boot.nvdgap.lm.cm.d<-boot.nvdgap.lm.cm-boot.nvdgap.obs
		boot.q21gap.rt.cm.d<-boot.q21gap.rt.cm-boot.q21gap.obs
		boot.nvdgap.rt.cm.d<-boot.nvdgap.rt.cm-boot.nvdgap.obs
		boot.q21gap.rf.cm.d<-boot.q21gap.rf.cm-boot.q21gap.obs
		boot.nvdgap.rf.cm.d<-boot.nvdgap.rf.cm-boot.nvdgap.obs
		boot.q21gap.sl.cm.d<-boot.q21gap.sl.cm-boot.q21gap.obs
		boot.nvdgap.sl.cm.d<-boot.nvdgap.sl.cm-boot.nvdgap.obs

		return(
			list(
				boot.q21gap.lm.cm,boot.nvdgap.lm.cm,
				boot.q21gap.rt.cm,boot.nvdgap.rt.cm,
				boot.q21gap.rf.cm,boot.nvdgap.rf.cm,
				boot.q21gap.sl.cm,boot.nvdgap.sl.cm,
				boot.q21gap.lm.cm.d,boot.nvdgap.lm.cm.d,
				boot.q21gap.rt.cm.d,boot.nvdgap.rt.cm.d,
				boot.q21gap.rf.cm.d,boot.nvdgap.rf.cm.d,
				boot.q21gap.sl.cm.d,boot.nvdgap.sl.cm.d))
		}

	boot.est.cm<-matrix(unlist(boot.est.cm),ncol=16,byrow=TRUE)

	mivar.lm.cm[i,1]<-var(boot.est.cm[,1])
	mivar.lm.cm[i,2]<-var(boot.est.cm[,2])
	mivar.rt.cm[i,1]<-var(boot.est.cm[,3])
	mivar.rt.cm[i,2]<-var(boot.est.cm[,4])
	mivar.rf.cm[i,1]<-var(boot.est.cm[,5])
	mivar.rf.cm[i,2]<-var(boot.est.cm[,6])
	mivar.sl.cm[i,1]<-var(boot.est.cm[,7])
	mivar.sl.cm[i,2]<-var(boot.est.cm[,8])

	midvar.lm.cm[i,1]<-var(boot.est.cm[,9])
	midvar.lm.cm[i,2]<-var(boot.est.cm[,10])
	midvar.rt.cm[i,1]<-var(boot.est.cm[,11])
	midvar.rt.cm[i,2]<-var(boot.est.cm[,12])
	midvar.rf.cm[i,1]<-var(boot.est.cm[,13])
	midvar.rf.cm[i,2]<-var(boot.est.cm[,14])
	midvar.sl.cm[i,1]<-var(boot.est.cm[,15])
	midvar.sl.cm[i,2]<-var(boot.est.cm[,16])
	}

### COMBINE MI ESTIMATES ###
lm.est.cm<-rt.est.cm<-rf.est.cm<-sl.est.cm<-matrix(data=NA,nrow=2,ncol=2)
lm.dif.cm<-rt.dif.cm<-rf.dif.cm<-sl.dif.cm<-matrix(data=NA,nrow=2,ncol=4)
...
# PRINT RESULTS #
#################
rlabel<-c('Q1incVsQ2inc','NoDiplomaVsDiploma')
...
sink("D:\\projects\\skill_gaps_lead\\programs\\appendix_a\\_LOGS\\01_create_table_a1_log.txt")
...
##### SAVE ESTIMATES #####
save(lm.gap.w1,lm.gap.w2,lm.gap.w3,lm.gap.cm,
     rt.gap.w1,rt.gap.w2,rt.gap.w3,rt.gap.cm,
     rf.gap.w1,rf.gap.w2,rf.gap.w3,rf.gap.cm,
     sl.gap.w1,sl.gap.w2,sl.gap.w3,sl.gap.cm,
     sl.dif.w1,sl.dif.w2,sl.dif.w3,sl.dif.cm,
     ob.gap,
     file="D:\\projects\\skill_gaps_lead\\data\\_TEMP\\appendix.a.ppvt.gap.est.RData")
