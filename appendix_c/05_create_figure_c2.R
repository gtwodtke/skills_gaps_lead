...
################################################
##                                            ##
## PROGRAM NAME: 04_create_figure_c2          ##
## AUTHOR: GW                                 ##
## DATE: 3/21/2021                            ##
## DESCRIPTION:                               ##
##                                            ##  
...
### LOAD ESTIMATES ###
load("D:\\projects\\skill_gaps_lead\\data\\_TEMP\\appendix.c.attn.gap.est.RData")
...
### PRINT OUTPUT
sink("D:\\projects\\skill_gaps_lead\\programs\\appendix_c\\_LOGS\\05_create_figure_c2_log.txt")
...
ggplot(output, aes(x=gap, y=est, fill=wave)) + 
	...
	scale_y_continuous(limits=c(-0.2,0.8),breaks=seq(from=-0.2,to=0.8,by=0.1)) +
...
ggsave("D:\\projects\\skill_gaps_lead\\figures\\figure_c2.tiff",width=6.5,height=5)
