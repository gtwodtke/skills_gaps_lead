...
#################################################
##                                             ##
## PROGRAM NAME: 03_create_table_c2            ##
## AUTHOR: GW                                  ##
## DATE: 3/21/2022                             ##
## DESCRIPTION:                                ##
##                                             ##
...
for (i in 1:nmi) {
	...
	idata<-phdcn[,c(vars.b.cm,vars.w1.cm,"natten_3","nbllprev_3","nbllprev_2","nbllprev_1","nsubage_3")]
	...
	boot.est.cm<-foreach(h=1:nboot, .combine=cbind) %dopar% {
		...
		boot.idata<-boot.phdcn[,c(vars.b.cm,vars.w1.cm,"natten_3","nbllprev_3","nbllprev_2","nbllprev_1","nsubage_3")]
...
sink("D:\\projects\\skill_gaps_lead\\programs\\appendix_c\\_LOGS\\03_create_table_c2_log.txt")
...
save(lm.gap.w1,lm.gap.w2,lm.gap.w3,lm.gap.cm,
     ...
     ob.gap,
     file="D:\\projects\\skill_gaps_lead\\data\\_TEMP\\appendix.c.attn.gap.est.RData")
