...
################################################
##                                            ##
## PROGRAM NAME: 18_create_table_5            ##
## DESCRIPTION:                               ##
##                                            ##
...
sink("D:\\projects\\skill_gaps_lead\\programs\\_LOGS\\18_create_table_5_log.txt")
...
save(lm.gap.w1,lm.gap.w2,lm.gap.w3,lm.gap.cm,
     ...
     ob.gap,
     file="D:\\projects\\skill_gaps_lead\\data\\_TEMP\\attn.gap.est.RData")
