...
log using "${project_directory}\programs\appendix_c\_LOGS\01_create_v03_phdcn_merged_mi.log", replace

/*
DO-FILE NAME: 12_create_v02_phdcn_merged_mi.do
AUTHOR: GW
DATE UPDATED: 03/21/2022 (GW)
...
mi impute chain ///
	...
	(pmm, include(ncondadvg_1 nBL5_1) knn(10)) ///
		...
		nBL5_2 nBL5_3 ///
		nSUBAge_3 nPPVTScore_3 nAttention_3 /// 
	, add(50) rseed(60657) augment dots
...
label var nbllprev_1 "Elevated BL prevalence (>5ug/dl) - wave 1"
label var nbllprev_2 "Elevated BL prevalence (>5ug/dl) - wave 2"
label var nbllprev_3 "Elevated BL prevalence (>5ug/dl) - wave 3"
...
saveold "${project_directory}\data\v03_phdcn_merged_mi.dta", replace version(12)
