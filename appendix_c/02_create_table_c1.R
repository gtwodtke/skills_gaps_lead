...
##  for PPVT scores under point-in-time and    ##
##  cumulative interventions on elev BL rates  ##
##                                             ##
#################################################
#################################################
...
##### LOAD PHDCN #####
phdcnmi<-read.dta("D:\\projects\\skill_gaps_lead\\data\\v03_phdcn_merged_mi.dta")
...
vars.w1<-c("nppvt_3",
	     "nblack_b","nhispan_b","nothrace_b",
           ...
           "nbllprev_1","nlninc_1","npcemply_1","npcwelf_1","npcmarr_1","npcengl_1","ncondadvg_1","nsubage_3")
vars.w2<-c(vars.w1,c("nbllprev_2","nlninc_2","npcemply_2","npcwelf_2","npcmarr_2","npcengl_2","ncondadvg_2"))
vars.w3<-c(vars.w2,c("nbllprev_3","nlninc_3","npcemply_3","npcwelf_3","npcmarr_3","npcengl_3","ncondadvg_3"))
...
for (i in 1:nmi) {
	...
	boot.est<-foreach(h=1:nboot, .combine=cbind) %dopar% {
		...
		boot.m0.race<-lm(nppvt_3~nblack_b+nhispan_b+nothrace_b,data=boot.phdcn)
		boot.m0.educ<-lm(nppvt_3~npccolgrd_b,data=boot.phdcn)
...
for (i in 1:nmi) {
	...
	resid_w2<-function(y) { residuals(lm(y~.,data=phdcn[,c(vars.b.cm,vars.w1.cm,"nbllprev_1")])) }
	resid_w3<-function(y) { residuals(lm(y~.,data=phdcn[,c(vars.b.cm,vars.w2.cm,"nbllprev_2")])) }
	...
	C<-cbind(1,
		phdcn$nlninc_2_r,
		phdcn$nlninc_2_r*phdcn$nbllprev_1,
		phdcn$nlninc_2_r*phdcn$nbllprev_2,
		...
		phdcn$npcemply_2_r,
		phdcn$npcemply_2_r*phdcn$nbllprev_1,
		phdcn$npcemply_2_r*phdcn$nbllprev_2,
		...
		phdcn$npcwelf_2_r,
		phdcn$npcwelf_2_r*phdcn$nbllprev_1,
		phdcn$npcwelf_2_r*phdcn$nbllprev_2,
		...
		phdcn$npcmarr_2_r,
		phdcn$npcmarr_2_r*phdcn$nbllprev_1,
		phdcn$npcmarr_2_r*phdcn$nbllprev_2,
		...
		phdcn$npcengl_2_r,
		phdcn$npcengl_2_r*phdcn$nbllprev_1,
		phdcn$npcengl_2_r*phdcn$nbllprev_2,
		...
		phdcn$ncondadvg_2_r,
		phdcn$ncondadvg_2_r*phdcn$nbllprev_1,
		phdcn$ncondadvg_2_r*phdcn$nbllprev_2,
		...
		phdcn$nlninc_3_r,
		phdcn$nlninc_3_r*phdcn$nbllprev_2,
		phdcn$nlninc_3_r*phdcn$nbllprev_3,
		...
		phdcn$npcemply_3_r,
		phdcn$npcemply_3_r*phdcn$nbllprev_2,
		phdcn$npcemply_3_r*phdcn$nbllprev_3,
		...
		phdcn$npcwelf_3_r,
		phdcn$npcwelf_3_r*phdcn$nbllprev_2,
		phdcn$npcwelf_3_r*phdcn$nbllprev_3,
		...
		phdcn$npcmarr_3_r,
		phdcn$npcmarr_3_r*phdcn$nbllprev_2,
		phdcn$npcmarr_3_r*phdcn$nbllprev_3,
		...
		phdcn$npcengl_3_r,
		phdcn$npcengl_3_r*phdcn$nbllprev_2,
		phdcn$npcengl_3_r*phdcn$nbllprev_3,
		...
		phdcn$ncondadvg_3_r,
		phdcn$ncondadvg_3_r*phdcn$nbllprev_2,
		phdcn$ncondadvg_3_r*phdcn$nbllprev_3,
	...
	y.train<-phdcn[,"nppvt_3"]
	x.train<-phdcn[,c(vars.b.cm,vars.w1.cm,"nbllprev_3","nbllprev_2","nbllprev_1","nsubage_3")]
	...
	idata<-phdcn[,c(vars.b.cm,vars.w1.cm,"nppvt_3","nbllprev_3","nbllprev_2","nbllprev_1","nsubage_3")]
	idata$nbllprev_3<-idata$nbllprev_2<-idata$nbllprev_1<-m	
	...
	boot.est.cm<-foreach(h=1:nboot, .combine=cbind) %dopar% {
		...
		boot.resid_w2<-function(y) { residuals(lm(y~.,data=boot.phdcn[,c(vars.b.cm,vars.w1.cm,"nbllprev_1")])) }
		boot.resid_w3<-function(y) { residuals(lm(y~.,data=boot.phdcn[,c(vars.b.cm,vars.w2.cm,"nbllprev_2")])) }
		...
		boot.C<-cbind(1,
			...
			boot.phdcn$nlninc_2_r*boot.phdcn$nbllprev_1,
			boot.phdcn$nlninc_2_r*boot.phdcn$nbllprev_2,
			...
			boot.phdcn$npcemply_2_r*boot.phdcn$nbllprev_1,
			boot.phdcn$npcemply_2_r*boot.phdcn$nbllprev_2,
			...
			boot.phdcn$npcwelf_2_r*boot.phdcn$nbllprev_1,
			boot.phdcn$npcwelf_2_r*boot.phdcn$nbllprev_2,
			...
			boot.phdcn$npcmarr_2_r*boot.phdcn$nbllprev_1,
			boot.phdcn$npcmarr_2_r*boot.phdcn$nbllprev_2,
			...
			boot.phdcn$npcengl_2_r*boot.phdcn$nbllprev_1,
			boot.phdcn$npcengl_2_r*boot.phdcn$nbllprev_2,
			...
			boot.phdcn$ncondadvg_2_r*boot.phdcn$nbllprev_1,
			boot.phdcn$ncondadvg_2_r*boot.phdcn$nbllprev_2,
			...
			boot.phdcn$nlninc_3_r*boot.phdcn$nbllprev_2,
			boot.phdcn$nlninc_3_r*boot.phdcn$nbllprev_3,
			...
			boot.phdcn$npcemply_3_r*boot.phdcn$nbllprev_2,
			boot.phdcn$npcemply_3_r*boot.phdcn$nbllprev_3,
			...
			boot.phdcn$npcwelf_3_r*boot.phdcn$nbllprev_2,
			boot.phdcn$npcwelf_3_r*boot.phdcn$nbllprev_3,
			...
			boot.phdcn$npcmarr_3_r*boot.phdcn$nbllprev_2,
			boot.phdcn$npcmarr_3_r*boot.phdcn$nbllprev_3,
			...
			boot.phdcn$npcengl_3_r*boot.phdcn$nbllprev_2,
			boot.phdcn$npcengl_3_r*boot.phdcn$nbllprev_3,
			...
			boot.phdcn$ncondadvg_3_r*boot.phdcn$nbllprev_2,
			boot.phdcn$ncondadvg_3_r*boot.phdcn$nbllprev_3,
		...
		boot.y.train<-boot.phdcn[,"nppvt_3"]
		boot.x.train<-boot.phdcn[,c(vars.b.cm,vars.w1.cm,"nbllprev_3","nbllprev_2","nbllprev_1","nsubage_3")]
		...
		boot.idata<-boot.phdcn[,c(vars.b.cm,vars.w1.cm,"nppvt_3","nbllprev_3","nbllprev_2","nbllprev_1","nsubage_3")]
		boot.idata$nbllprev_3<-boot.idata$nbllprev_2<-boot.idata$nbllprev_1<-m 
...
sink("D:\\projects\\skill_gaps_lead\\programs\\appendix_c\\_LOGS\\02_create_table_c1_log.txt")
...
save(lm.gap.w1,lm.gap.w2,lm.gap.w3,lm.gap.cm,
     ...
     ob.gap,
     file="D:\\projects\\skill_gaps_lead\\data\\_TEMP\\appendix.c.ppvt.gap.est.RData")
