...
################################################
##                                            ##
## PROGRAM NAME: 20_create_figure_5           ##
## DESCRIPTION:                               ##
##                                            ##  
...
### PRINT OUTPUT
sink("D:\\projects\\skill_gaps_lead\\programs\\_LOGS\\20_create_figure_5_log.txt")
...
ggplot(output, aes(x=gap, y=est, fill=wave)) + 
	...
	scale_y_continuous(limits=c(-0.275,0.8),breaks=seq(from=-0.2,to=0.8,by=0.1)) +
...
ggsave("D:\\projects\\skill_gaps_lead\\figures\\figure_5.tiff",width=6.5,height=5)
